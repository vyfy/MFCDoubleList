...
// MFCDoubleList.cpp : Определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CMFCDoubleListApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// создание CMFCDoubleListApp

CMFCDoubleListApp::CMFCDoubleListApp()
{
...
// Единственный объект CMFCDoubleListApp

CMFCDoubleListApp theApp;


// инициализация CMFCDoubleListApp

BOOL CMFCDoubleListApp::InitInstance()
{
